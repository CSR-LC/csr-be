...
type UserUpdateParams struct {
	...
	/*Data to update.
	  ...
	  In: body
	*/
	UpdateUserTask *models.UpdateUserTask
	/*user id
	  Required: true
	  In: path
	*/
...
func (o *UserUpdateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateUserTask
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("updateUserTask", "body", ""))
			} else {
				res = append(res, errors.NewParseError("updateUserTask", "body", "", err))
			}
		} else {
